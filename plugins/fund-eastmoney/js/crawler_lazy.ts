...
console.log("[crawler_lazy.ts] going to work for url=", window.location.href)
...
function handleClick(event: MouseEvent) {
  ...
  console.log("[crawler_lazy.ts] handleClick target is HTMLAnchorElement?", target, target instanceof HTMLAnchorElement)
  ...
  if (target instanceof HTMLAnchorElement && target.tagName === "A") {
    ...
    console.log("[crawler_lazy.ts] trying to window.open url _self", url)
